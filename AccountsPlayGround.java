...
public class AccountsPlayGround {
    ...
    {
        Checkings accountChecking = new Checkings("123456", new BigDecimal(1000));
        Savings accountSavings = new Savings("23445566", new BigDecimal(1000));
        System.out.println(accountChecking.withdrawAmount(new BigDecimal(100)));
        System.out.println(accountSavings.depositAmount(new BigDecimal(100)));
