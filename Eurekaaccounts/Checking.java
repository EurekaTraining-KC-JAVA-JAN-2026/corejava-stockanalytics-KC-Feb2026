...
public class Checking extends Accounts {
    private static  BigDecimal cashback =new BigDecimal(3.0) ;
    public static BigDecimal cashb = new BigDecimal(3.0);
    ...
    public BigDecimal withdrawAmout(BigDecimal withdrawAmount) {
        BigDecimal cashb = withdrawAmount.multiply(cashback).divide(new BigDecimal(100));
