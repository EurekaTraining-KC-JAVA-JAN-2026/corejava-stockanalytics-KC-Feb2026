...
public class AccountsListPlayGround {
    public static void main(String[] args) {
        ...
        accountsList.add(new Checkings("23432",new BigDecimal(200)));
       // System.out.println(accountsList);
        accountsList.add(new Savings("12321",new BigDecimal(10)));
        accountsList.add(new Savings("23432",new BigDecimal(20)));
        System.out.println(accountsList);
