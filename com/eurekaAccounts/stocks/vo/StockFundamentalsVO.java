...
public class StockFundamentalsVO implements Comparable<StockFundamentalsVO>{
    ...
    public StockFundamentalsVO(String tickerSymbol, BigDecimal sectorId, BigDecimal subsectorId, BigDecimal marketCap, float currentRatio, float priceToBookRa, float peg, float epsqq, float epsNxtYear) {
