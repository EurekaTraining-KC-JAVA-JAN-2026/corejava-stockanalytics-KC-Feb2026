...
import com.AssignmentsInterface.Cube;
import com.AssignmentsInterface.Cuboid;
import com.AssignmentsInterface.Cylinder;
...
public class Shapes3DPlayGround {
    public static void main(String[] args) {
        ...
        Cube cube = new Cube(new BigDecimal(20));
        Cuboid cuboid = new Cuboid(new BigDecimal(5),new BigDecimal(8), new BigDecimal(2));
        Cylinder cylinder = new Cylinder(new BigDecimal(4), new BigDecimal(5));
